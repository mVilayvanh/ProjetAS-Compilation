...
{
       0,    51,    51,    74,    83,    88,    93,    99,   103,   109,
     116,   128,   141,   147,   153,   161,   169,   189,   198,   203,
...
{
  "$end", "error", "$undefined", "TYPE", "VOID", "IF", "ELSE", "WHILE",
  "RETURN", "OR", "AND", "ORDER", "EQ", "IDENT", "NUM", "CHARACTER",
  "ADDSUB", "DIVSTAR", "THEN", "';'", "','", "'('", "')'", "'{'", "'}'",
  "'='", "'!'", "$accept", "Prog", "DeclarVarGlob", "DeclarateursGlob",
  "DeclFoncts", "DeclFonct", "EnTeteFonct", "Parametres", "ListTypVar",
  "Corps", "DeclarVarLoc", "DeclarateursLoc", "Affectation", "SuiteInstr",
...
#line 1614 "src/tpcas.tab.c"
    break;

  case 17:
#line 189 "src/tpcas.y"
                                                {
                                                    if (!varLoc_flag)
                                                        varLoc_flag = 1;
                                                    Node *child;
...
#line 1811 "src/tpcas.tab.c"
    break;

  case 35:
#line 306 "src/tpcas.y"
                                                {
                                                    (yyval.node) = (yyvsp[0].node);
                                                }
#line 1819 "src/tpcas.tab.c"
    break;

  case 36:
#line 310 "src/tpcas.y"
                                                {
                                                    (yyval.node) = makeNode(and);
                                                    addChild((yyval.node), (yyvsp[-2].node));
                                                    addChild((yyval.node), (yyvsp[0].node));
                                                }
#line 1829 "src/tpcas.tab.c"
    break;

  case 37:
#line 315 "src/tpcas.y"
                                                {
                                                    (yyval.node) = (yyvsp[0].node);
                                                }
#line 1837 "src/tpcas.tab.c"
    break;
...
#line 1848 "src/tpcas.tab.c"
    break;

  case 39:
#line 325 "src/tpcas.y"
                                                {
                                                    (yyval.node) = (yyvsp[0].node);
                                                }
#line 1856 "src/tpcas.tab.c"
    break;

  case 40:
#line 329 "src/tpcas.y"
                                                {
...
#line 1867 "src/tpcas.tab.c"
    break;

  case 41:
#line 336 "src/tpcas.y"
                                                {
                                                    (yyval.node) = (yyvsp[0].node);
                                                }
#line 1875 "src/tpcas.tab.c"
    break;

  case 42:
#line 340 "src/tpcas.y"
                                                {
...
#line 1886 "src/tpcas.tab.c"
    break;

  case 43:
#line 346 "src/tpcas.y"
                                                {
                                                    (yyval.node) = (yyvsp[0].node);
                                                }
#line 1894 "src/tpcas.tab.c"
    break;

  case 44:
#line 350 "src/tpcas.y"
                   {
...
#line 1905 "src/tpcas.tab.c"
    break;

  case 45:
#line 356 "src/tpcas.y"
                                                {
                                                    (yyval.node) = (yyvsp[0].node);
                                                }
#line 1913 "src/tpcas.tab.c"
    break;

  case 46:
#line 360 "src/tpcas.y"
                                                {
                                                    (yyval.node) = makeNode(UnaryAddsub);
                                                    (yyval.node)->name = strdup((yyvsp[-1].byte));
                                                    addChild((yyval.node), (yyvsp[0].node));
                                                }
#line 1923 "src/tpcas.tab.c"
    break;

  case 47:
#line 365 "src/tpcas.y"
                                                {
                                                    (yyval.node) = makeNode(not);
                                                    addChild((yyval.node), (yyvsp[0].node));
                                                }
#line 1932 "src/tpcas.tab.c"
    break;

  case 48:
#line 369 "src/tpcas.y"
                                                {
                                                    (yyval.node) = (yyvsp[-1].node);
                                                }
#line 1940 "src/tpcas.tab.c"
    break;

  case 49:
#line 372 "src/tpcas.y"
                                                {
                                                    (yyval.node) = makeNode(Num);
                                                    (yyval.node)->isnum = 1;
                                                    (yyval.node)->val = (yyvsp[0].num);
                                                }
#line 1950 "src/tpcas.tab.c"
    break;

  case 50:
#line 377 "src/tpcas.y"
                                                {
                                                    (yyval.node) = makeNode(Character);
                                                    (yyval.node)->name = strdup((yyvsp[0].byte)); 
                                                }
#line 1959 "src/tpcas.tab.c"
    break;

  case 51:
#line 381 "src/tpcas.y"
                                                { 
                                                    (yyval.node) = (yyvsp[0].node);
                                                }
#line 1967 "src/tpcas.tab.c"
    break;

  case 52:
#line 384 "src/tpcas.y"
                                                {    
                                                    (yyval.node) = makeNode(Ident);
                                                    (yyval.node)->name = strdup((yyvsp[-3].ident));
                                                    addChild((yyval.node), (yyvsp[-1].node));
                                                }
#line 1977 "src/tpcas.tab.c"
    break;
...
#line 2020 "src/tpcas.tab.c"
    break;


#line 2024 "src/tpcas.tab.c"
